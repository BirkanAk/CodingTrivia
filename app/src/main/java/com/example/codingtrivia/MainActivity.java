...
public class MainActivity extends AppCompatActivity {
    ...
    public void onInfoClick(View view) {
        ...
        infoDialog.setMessage("Welcome to our game, Coding Trivia! \nWe have 3 game modes: \n\n • Quick Play: It is a basic mode for improving your skills in Python, Java and C++ with beginner level questions. \n • Time Trials: This mode will test your coding skills with a timer which is counting down. You must be hurry! \n • Binghamtin Quiz: This mode is a fun mode just created for Binghamton University students. Do you really think that you know Binghamton well enough?  \n\n You can also change the language in Change Coding Language view! \n\nHave fun");
